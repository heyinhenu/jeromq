...
public class ZProxy {
    ...
    public enum Command {
        START, PAUSE, STOP, RESTART, EXIT, STATUS, CONFIG
    }
    ...
    public enum State {
        ALIVE, STARTED, PAUSED, STOPPED, EXITED
    }
    ...
    private static final class ProxyActor extends ZActor.SimpleActor {
        ...
        private static final class State {
            ...
            public String toString() {
                return "State [alive=" + alive + ", started=" + started + ", paused=" + paused + ", restart=" + restart + ", hot=" + hot + "]";
            }
